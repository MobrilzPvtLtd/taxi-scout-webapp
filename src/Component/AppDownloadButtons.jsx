      ...
      <div className="container px-2 md:flex lg:px-10 pt-5">
        <div className="flex flex-col items-center justify-center px-5 w-full md:w-1/2">
          ...
          <div className="flex flex-row justify-center items-center space-x-4">
            <a href="https://play.google.com/store/apps/details?id=com.taxiscout.user&pcampaignid=web_share" target="_blank" rel="noopener noreferrer">
              <img
        ...
        <div className="hidden md:flex justify-center items-center w-1/2">
          <img className="w-96" src={mobileTaxi} alt="Mobile App Preview" />
        </div>
      </div>
    </div>
  );
