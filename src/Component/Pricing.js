  ...
  return (
    <>
      {loading ? (
        ...
        <section className="bg-gradient-to-r from-yellow-500 to-orange-500 py-12 mt-16  ">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <div className="text-4xl font-extrabold text-black sm:text-5xl">
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              {price?.map((item, index) => (
                ...
                >
                  ...
                  <div className="mb-8">
                    <h3 className="text-xs  sm:text-sm md:text-lg lg:text-xl font-semibold text-black">
                      {item.package_name}
                    </h3>
                  ...
                  <div className="mb-8">
                    ...
                    <span className="text-xl font-medium text-black-300">/{t(`pricing_text3`)}</span>
                  </div>
                  ...
                  <Link
                    ...
                    className="block w-full py-3 px-6 text-center rounded-md text-black font-semibold bg-gradient-to-r from-yellow-600 to-[#ffd91c] hover:from-yellow-700 hover:to-orange-400"
                  >
                     {t(`pricing_text6`)}
                  </Link>
                </div>
