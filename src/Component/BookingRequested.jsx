...
const BookingCompleted = ({ 
  ...
  handleOnCancels, bill, driverProfile, car_number
}) => {
  ...
  const { base_price, distance_price, time_price, waiting_charge, 
          cancellation_fee, promo_discount, service_tax, total_amount } = bill?.data || {}; 
...
// ✅ Ensure this styles object is present!
const styles = {
  container: {
    display: "flex",
